...
SECRET_KEY = 'django-insecure-5nbkf8ev2+0gg3hl@ec=tqkv8^j4$=$5+tsl-!hw$_&^&!lv!!'
...
MEDIA_ROOT = '/home/TcManagement/TcManagement/media'
MEDIA_URL = '/media/'
STATIC_ROOT = '/home/TcManagement/TcManagement/static'
STATIC_URL = '/static/'
...
# Additional directories to include static files from during development
STATICFILES_DIRS = [
